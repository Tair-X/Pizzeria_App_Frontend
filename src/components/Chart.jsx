...
import {
    ...
    minusCartItemsAction,
    plusCartItemsAction
} from "../redux/actions/addPizzaToCartAction";
import emptyCart from "../assets/img/empty-cart.png"
import {Link} from "react-router-dom";

export const Busket = (props) => {
    ...
    let minusCartItems=(id)=>{
        dispatch(minusCartItemsAction(id))
    }

    let plusCartItems=(id)=>{
        dispatch(plusCartItemsAction(id))
    }
              ...
              {totalCount!=0?<div className="cart">
                  <div className="cart__top">
                      ...
                      <div className="cart__clear" >
                          ...
                          <span onClick={cleanCart}>Очистить корзину</span>
                      </div>
                  </div>
                  <div className="content__items">

                      {addedPizzas.map((obj)=>{
                          return(<CartItem  onPlusItems={plusCartItems} onMinusItems={minusCartItems} id={obj.id} onDeleteCartItems={deleteCartItems} totalPrice={items[obj.id].totalPrice}  totalCount={items[obj.id].items.length}   size={obj.activeSize}  type={obj.activeType} name={obj.name} price={obj.price}/>)
